...
def build_os2d_from_config(cfg, channel_information_path="./src/db/prune_channel_information.csv"):
    ...
    optimizer_state = net.init_model_from_file(cfg.init.model, init_affine_transform_path=cfg.init.transform, channel_information_path=channel_information_path)
...
class Os2dModel(nn.Module):
    ...
    def init_model_from_file(self, path, init_affine_transform_path="", channel_information_path = "./src/db/prune_channel_information.csv"):
        ...
        try:
            ...
            if checkpoint and "net" in checkpoint:
                self.logger.info("Loaded feature extractor from checkpoint")
            ...
            try:
                ...
                checkpoint = torch.load(path, map_location='cuda' if self.is_cuda else 'cpu',  weights_only=False)
