...
def generate_detection_boxes(dataloader, net, img_normalization , box_coder, image_id, class_id, cfg, class_num=0, debug_or_eval=False):
    """
    生成指定圖像和類別的檢測框
    ...
    cfg.defrost()
    cfg.visualization.eval.max_detections = class_num*2
    ...
    if not debug_or_eval:
        ...
        return scaled_boxes, filtered_labels, filtered_scores
    else:
