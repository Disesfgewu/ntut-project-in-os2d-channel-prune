...
cfg.init.transform = "./models/weakalign_resnet101_affine_tps.pth.tar"
...
cfg.train.objective.loc_weight = 0.0
...
cfg.visualization.eval.path_to_save_detections = f"{cfg.output.path}/detections"
