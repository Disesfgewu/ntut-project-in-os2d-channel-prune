...
def show_detections(boxes, image_to_show,
                    cfg_visualization,
                    class_ids=None, image_id=None, show_fig=True):
...
def show_annotated_image(img, boxes, labels, scores, class_ids, score_threshold=0.0,
                         ...
                         max_dets=None, showfig=False, image_id=None, path=None):
...
def vis_image(img, boxes=None, label_names=None, scores=None, colors=None, image_id=None, polygons=None,showfig=False, path=None):
